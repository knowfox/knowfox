...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'concepts' => Knowfox\GraphQL\Queries\ConceptsQuery::class,
            ],
            'mutation' => [
    ...
    //
    'types' => [
        'Concept' => Knowfox\GraphQL\Types\ConceptType::class,
        'Relationship' => Knowfox\GraphQL\Types\RelationshipType::class,
        'User' => Knowfox\GraphQL\Types\UserType::class,
    ],
